...
ANOTHER ISSUE WITH THE IMAGES: THEY ARE NOT KNITING INLINE WHERE WE PLACE THEM. INSTEAD THEY JUST SHOW UP RANDOMLY THROUGH-OUT THE PDF. I THINK THE SOLUTION TO ALL THESE ISSUES IS TO GO WITH THE KNITR PACKAGE

ALSO, LATEX AUTONUMBERS THE FIGURES. SO, IN EACH FIGURE CAPTION WHERE WE HAVE CURRENTLY TYPED 'Figure #' NEEDS TO BE DELETED AND FILLED IN WITH A DESCRIPTION FIGURE CAPTION. SEE THE MOST RECENT UPLOADED PDF TO SEE WHAT I MEAN.
...
Breaking divergence down by sector gives a deeper look into market trends (see Figure ADD FIGURE NUMBER). This view reinforces the divergence rate as a metric to describe market behavior. Take the energy sector as an example. Leading up to the recession, the Iraq War caused a global oil shortage. (ADD THIS TO OUR CITATIONS:  https://www.brookings.edu/research/iraqs-oil-sector-one-year-after-liberation/) In response, oil prices rose significantly. Figure ADD FIGURE NUMBER shows the market response in the energy sector to the increase in oil prices over the years 2005 to 2008. During the recession, the energy sector remained overvalued when all other sectors became undervalued in 2008. But, as the region began to recover in the following years (ADD THIS TO OUR CITATIONS: https://jia.sipa.columbia.edu/war-oil-price-cycle), the valuation of the energy sector normalized. Seeing real world events reflected in the divergence rate adds confidence to this methodology.

![Figure #.](all_sectors_divergence.jpg)  

### Real Estate   

Briefly, we want to highlight the divergence rate trends in the real estate sector, given the importance of real estate products and housing prices to the Great Recession. (ADD CITATION: https://furmancenter.org/files/publications/HousingandtheGreatRecession.pdf) In the early 2000's, mortgage lenders began extending credit to higher risk borrowers and apportioning this risk out to investors through private-label mortgage backed securities. (ADD CITATION: https://www.federalreservehistory.org/essays/subprime_mortgage_crisis) Adding more buyers to the market caused a spike in housing prices, leading to the overvaluing of the real estate market shown in Figure ADD FIGURE NUMBER during the years 2005, 2006, and 2007. Then, as high-risk lenders began to default on their loans en masse, the real estate market collapsed, leading to losses as the market became saturated with properties. Figure ADD FIGURE NUMBER shows this in the years from 2007 to 2012. Now, new regulations including the Dodd-Frank act have stabilized the market (ADD CITATION: https://knowledge.wharton.upenn.edu/article/housing-mortgage-markets-may-recovered-risks-remain/), shown in the years from 2013 onward. This anecedote offers further evidence that the divergence rate metric accurately tracks market trends. 

![Figure #.](real_estate_divergence.jpg)

### FAANG Stocks  

To fully assess the performance of the Diversion Rate metric, we also looked into the behavior of the so-called FAANG stocks, composed of Facebook, Apple, Amazon, Netflix, and Google. Collectively, these stocks make up about 37% of the NASDAQ composite index, about 12% of the S&P 500, and about 5% of the Dow Jones index (calculated May 29, 2019). These stocks provide an alternate look at how well Diversion Rate tracks market trends because, during the entire first recession, these stocks had very different performance rates than the majority of the market. Unlike other stocks, the FAANG collection entered the recession undervalued and displayed meteoric year-over-year growth until recently. Now, the majority of these stocks are considered over-valued by our model. Recent headlines such as "A Toothless FAANG" in Forbes and "It's Time to Break up the FAANGs" in Markets Insider hint that the investment community has begun to feel wary of this group of stocks. The fact that our divergence rate metric reflects the overvaluation of these stocks provides more evidence that divergence rate offers insight into market trends. 

![Divergence Rate trends for Facebook, Apple, Amazon, Netflix and Google](faang_stocks_divergence_dist.jpg)
...
ADD THIS TO OUR CITATIONS: 
Oil Prices and the Iraq War: Market Interpretations of Military
Developments
Strategic Insights, Volume II, Issue 4 (April 2003)
by Robert Looney 

ADD THIS TO OUR CITATIONS:
https://www.forbes.com/sites/katinastefanova/2019/01/27/a-toothless-faang/#55760fcd672f

ADD THIS TO OUR CITATIONS:
https://markets.businessinsider.com/news/stocks/amazon-apple-facebook-netflix-google-break-up-faangs-2019-1-1027916057
