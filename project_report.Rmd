...
WE NEED A FEW PARAGRAPHS ABOUT WHY THIS PROBLEM IS RELEVANT AND WORTH RESEARCHING. SOMETHING ABOUT HOW RECESSIONS ARE AN INEVITABILITY AND SO FINDING ADDITIONAL METRICS TO GIVE US INFORMATION ABOUT THEM IS VALUABLE, SINCE THE MARKET ISN'T RATIONAL (I.E. STOCK PRICE IS DETERMINED BY BOTH DEMAND AND COMPANY VALUE) BUT, IN THE END, A STOCK IS ONLY AS VALUABLE AS THE COMPANY THE INVESTOR HAS PURCHASED. 
